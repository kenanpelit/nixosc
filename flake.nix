...

{
  ...
  inputs = {
    ...
    hyprland = {
      ...
      url = "github:hyprwm/hyprland/b9bd9d147fc00b7cc65f9545722182720cbd521d"; # 0102 - Updated commit
#      url = "github:hyprwm/hyprland/31d3181e1ee91e338fb4fb8207d64b8d689310fc"; # 0102 - Updated commit
