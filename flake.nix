...
# ==============================================================================
{
 ...
 inputs = {
   ...
   hyprland = {
     url = "github:hyprwm/hyprland/ccbdba7ee2ccb835306de89a6023134fa6b8006f"; # 0322 - 5915
     #url = "github:hyprwm/hyprland/2ddd16ef28bfd3687d21f0052fe958af1914aa5f"; # 0316 - 5893
     inputs.nixpkgs.follows = "nixpkgs";
   };
