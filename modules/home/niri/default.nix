...
# ==============================================================================
# Home module for the niri compositor with DMS-friendly keybinds and helpers.
# Writes a config.kdl with absolute paths, starts dms/nirius/niriswitcher, and
# maps keybinds similar to the Hyprland setup (kitty on Super+Return).
# ==============================================================================
{ config, lib, pkgs, ... }:
let
