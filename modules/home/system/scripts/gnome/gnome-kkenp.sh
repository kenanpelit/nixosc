...
set -e
echo "🚀 Initializing kkenp for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting kkenp on workspace 2..."
...
echo "✅ kkenp started (PID: $APP_PID) on workspace 2"
