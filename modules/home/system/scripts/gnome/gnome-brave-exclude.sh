...
set -e
echo "🚀 Initializing brave-exclude for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-exclude on workspace 6..."
...
echo "✅ brave-exclude started (PID: $APP_PID) on workspace 6"
...
echo "🎉 brave-exclude launch completed!"
exit 0
