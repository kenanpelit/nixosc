...
set -e
echo "🚀 Initializing mkenp for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting mkenp on workspace 2..."
...
echo "✅ mkenp started (PID: $APP_PID) on workspace 2"
