...
set -e
echo "🚀 Initializing spotify for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting spotify on workspace 8..."
...
echo "✅ spotify started (PID: $APP_PID) on workspace 8"
