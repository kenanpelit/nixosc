...
set -e
echo "🚀 Initializing zen-compecta for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting zen-compecta on workspace 4..."
...
echo "✅ zen-compecta started (PID: $APP_PID) on workspace 4"
...
echo "🎉 zen-compecta launch completed!"
exit 0
