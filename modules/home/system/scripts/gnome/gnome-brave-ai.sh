...
set -e
echo "🚀 Initializing brave-ai for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-ai on workspace 3..."
...
echo "✅ brave-ai started (PID: $APP_PID) on workspace 3"
...
echo "🎉 brave-ai launch completed!"
exit 0
