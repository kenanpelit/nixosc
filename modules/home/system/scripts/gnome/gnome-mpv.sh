...
set -e
echo "🚀 Initializing mpv for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting mpv on workspace 6..."
...
echo "✅ mpv started (PID: $APP_PID) on workspace 6"
