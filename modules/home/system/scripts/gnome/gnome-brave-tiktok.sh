...
set -e
echo "🚀 Initializing brave-tiktok for GNOME/Wayland with FIXED workspace switching..."
...
if [[ "6" != "0" ]]; then
    echo "🎯 Switching to workspace 6 using wmctrl..."
...
echo "🚀 Starting brave-tiktok on workspace 6..."
...
echo "✅ brave-tiktok started (PID: $APP_PID) on workspace 6"
...
echo "🎉 brave-tiktok launch completed!"
exit 0
