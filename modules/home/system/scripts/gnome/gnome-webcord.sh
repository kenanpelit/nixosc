...
set -e
echo "🚀 Initializing webcord for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting webcord on workspace 5..."
...
echo "✅ webcord started (PID: $APP_PID) on workspace 5"
