...
set -e
echo "🚀 Initializing wezterm for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting wezterm on workspace 2..."
...
echo "✅ wezterm started (PID: $APP_PID) on workspace 2"
