...
set -e
echo "🚀 Initializing discord for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting discord on workspace 5..."
...
echo "✅ discord started (PID: $APP_PID) on workspace 5"
