...
set -e
echo "🚀 Initializing wkenp for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting wkenp on workspace 2..."
...
echo "✅ wkenp started (PID: $APP_PID) on workspace 2"
