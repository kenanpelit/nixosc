...
set -e
echo "🚀 Initializing brave-discord for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-discord on workspace 5..."
...
echo "✅ brave-discord started (PID: $APP_PID) on workspace 5"
...
echo "🎉 brave-discord launch completed!"
exit 0
