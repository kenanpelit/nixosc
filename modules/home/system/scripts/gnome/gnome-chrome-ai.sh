...
set -e
echo "🚀 Initializing chrome-ai for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting chrome-ai on workspace 3..."
...
echo "✅ chrome-ai started (PID: $APP_PID) on workspace 3"
...
echo "🎉 chrome-ai launch completed!"
exit 0
