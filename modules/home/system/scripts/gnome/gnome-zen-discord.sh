...
set -e
echo "🚀 Initializing zen-discord for GNOME/Wayland with FIXED workspace switching..."
...
if [[ "5" != "0" ]]; then
    echo "🎯 Switching to workspace 5 using wmctrl..."
    TARGET_WORKSPACE=$((5 - 1))  # Convert to 0-based indexing
    
    if command -v wmctrl >/dev/null 2>&1; then
        wmctrl -s "$TARGET_WORKSPACE"
        sleep 1  # Just 1 second is enough
        echo "✅ Switched to workspace 5"
    else
...
echo "🚀 Starting zen-discord on workspace 5..."
...
echo "✅ zen-discord started (PID: $APP_PID) on workspace 5"
...
echo "🎉 zen-discord launch completed!"
exit 0
