...
set -e
echo "Initializing zen-discord for GNOME/Wayland..."
...
APP_PID=$!
mkdir -p "/tmp/semsumo"
echo "$APP_PID" > "/tmp/semsumo/zen-discord.pid"
echo "Application started (PID: $APP_PID)"

# Wait for application to load and ensure correct workspace
sleep 3
if [[ "5" != "0" ]] && command -v gdbus >/dev/null 2>&1; then
