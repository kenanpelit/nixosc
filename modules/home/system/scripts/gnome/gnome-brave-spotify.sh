...
set -e
echo "🚀 Initializing brave-spotify for GNOME/Wayland with FIXED workspace switching..."
...
if [[ "8" != "0" ]]; then
    echo "🎯 Switching to workspace 8 using wmctrl..."
    TARGET_WORKSPACE=$((8 - 1))  # Convert to 0-based indexing
    
    if command -v wmctrl >/dev/null 2>&1; then
        wmctrl -s "$TARGET_WORKSPACE"
        sleep 1  # Just 1 second is enough
        echo "✅ Switched to workspace 8"
    else
...
echo "🚀 Starting brave-spotify on workspace 8..."
...
echo "✅ brave-spotify started (PID: $APP_PID) on workspace 8"
...
echo "🎉 brave-spotify launch completed!"
exit 0
