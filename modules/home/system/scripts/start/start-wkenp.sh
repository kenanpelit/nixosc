...
echo "[2025-04-18 15:16:12] Starting $PROFILE..."
    ...
    bypass)
        ...
        if [[ "$VPN_STATUS" == "connected" ]]; then
            if command -v mullvad-exclude >/dev/null 2>&1; then
                ...
                mullvad-exclude wezterm "start" "--class" "TmuxKenp" "" "tm" &
            else
