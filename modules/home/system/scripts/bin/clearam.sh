...
#===============================================================================
#
#   Script: OSC Memory Cleanup Tool
#   Version: 1.0.0
#   Date: 2024-01-23
#   Author: Kenan Pelit
#   Repository: https://github.com/kenanpelit/nixosc
#   Description: Advanced system memory management utility for RAM optimization
#                and cache cleanup with detailed reporting
#
#   Features:
#   - RAM and cache memory cleanup
#   - Swap management and reset
