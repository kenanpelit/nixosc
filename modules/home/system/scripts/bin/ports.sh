...
# Gelişmiş Ağ ve Port Tarama Scripti
# Gereksinimler:
# - nmap: Ağ tarama
# - net-tools: ARP tablosu için
# - netcat: Port tarama
# - iproute2: IP bilgisi alma
# - ping: Host kontrolü
#
# Kurulum:
# Arch Linux: sudo pacman -S nmap net-tools gnu-netcat iproute2 iputils
# Ubuntu/Debian: sudo apt install nmap net-tools netcat iproute2 iputils-ping
# RHEL/CentOS: sudo yum install nmap net-tools nc iproute iputils
#
# Özellikler:
# - Ağ keşfi (network discovery)
# - TCP ve UDP port taraması
# - Tek port, port aralığı veya port listesi tarama
# - Timeout kontrolü
