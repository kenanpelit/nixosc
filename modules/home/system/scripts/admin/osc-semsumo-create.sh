...
#   Version: 1.1.0
#   Date: 2025-03-25
#   Author: Kenan Pelit (original), Claude (improvements)
...
create_script() {
	...
	log_verbose "Creating script: $script_path"
...
process_profiles() {
	...
	# Process each profile and generate scripts for different modes
	...
	echo "----------------------------------------"
	log_success "Script generation complete! Generated $(($total_profiles * 3)) scripts."
}
...
main() {
	...
	echo "  $SCRIPTS_DIR/start-$example_profile-always.sh"
	echo "  $SCRIPTS_DIR/start-$example_profile-never.sh"
	echo "  $SCRIPTS_DIR/start-$example_profile-default.sh"
}
