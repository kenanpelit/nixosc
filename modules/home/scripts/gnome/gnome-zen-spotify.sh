...
set -e
echo "🚀 Initializing zen-spotify for GNOME/Wayland with FIXED workspace switching..."
...
if [[ "7" != "0" ]]; then
    echo "🎯 Switching to workspace 7 using wmctrl..."
    TARGET_WORKSPACE=$((7 - 1))  # Convert to 0-based indexing
    
    if command -v wmctrl >/dev/null 2>&1; then
        wmctrl -s "$TARGET_WORKSPACE"
        sleep 1  # Just 1 second is enough
        echo "✅ Switched to workspace 7"
    else
...
echo "🚀 Starting zen-spotify on workspace 7..."
...
echo "✅ zen-spotify started (PID: $APP_PID) on workspace 7"
...
echo "🎉 zen-spotify launch completed!"
exit 0
