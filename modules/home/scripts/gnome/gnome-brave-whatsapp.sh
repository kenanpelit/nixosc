...
set -e
echo "🚀 Initializing brave-whatsapp for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-whatsapp on workspace 9..."
...
echo "✅ brave-whatsapp started (PID: $APP_PID) on workspace 9"
...
echo "🎉 brave-whatsapp launch completed!"
exit 0
