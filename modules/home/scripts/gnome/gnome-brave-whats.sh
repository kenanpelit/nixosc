...
set -e
echo "🚀 Initializing brave-whats for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-whats on workspace 9..."
...
echo "✅ brave-whats started (PID: $APP_PID) on workspace 9"
...
echo "🎉 brave-whats launch completed!"
exit 0
