...
set -e
echo "🚀 Initializing zen-kenp for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting zen-kenp on workspace 1..."
...
echo "✅ zen-kenp started (PID: $APP_PID) on workspace 1"
...
echo "🎉 zen-kenp launch completed!"
exit 0
