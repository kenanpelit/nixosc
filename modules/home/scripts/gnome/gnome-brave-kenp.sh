...
set -e
echo "🚀 Initializing brave-kenp for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-kenp on workspace 1..."
...
echo "✅ brave-kenp started (PID: $APP_PID) on workspace 1"
...
echo "🎉 brave-kenp launch completed!"
exit 0
