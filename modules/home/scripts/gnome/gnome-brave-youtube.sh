...
set -e
echo "🚀 Initializing brave-youtube for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting brave-youtube on workspace 7..."
...
echo "✅ brave-youtube started (PID: $APP_PID) on workspace 7"
...
echo "🎉 brave-youtube launch completed!"
exit 0
