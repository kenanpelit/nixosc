...
set -e
echo "🚀 Initializing zen-whats for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting zen-whats on workspace 9..."
...
echo "✅ zen-whats started (PID: $APP_PID) on workspace 9"
...
echo "🎉 zen-whats launch completed!"
exit 0
