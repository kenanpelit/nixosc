...
set -e
echo "🚀 Initializing zen-proxy for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting zen-proxy on workspace 7..."
...
echo "✅ zen-proxy started (PID: $APP_PID) on workspace 7"
...
echo "🎉 zen-proxy launch completed!"
exit 0
