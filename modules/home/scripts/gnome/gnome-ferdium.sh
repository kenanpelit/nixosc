...
set -e
echo "🚀 Initializing ferdium for GNOME/Wayland with FIXED workspace switching..."
...
echo "🚀 Starting ferdium on workspace 9..."
...
echo "✅ ferdium started (PID: $APP_PID) on workspace 9"
