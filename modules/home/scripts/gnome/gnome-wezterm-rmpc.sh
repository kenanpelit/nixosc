...
set -e
echo "🚀 Initializing wezterm-rmpc for GNOME/Wayland with FIXED workspace switching..."
...
if [[ "0" != "0" ]]; then
    echo "🎯 Switching to workspace 0 using wmctrl..."
    TARGET_WORKSPACE=$((0 - 1))  # Convert to 0-based indexing
    
    if command -v wmctrl >/dev/null 2>&1; then
        wmctrl -s "$TARGET_WORKSPACE"
        sleep 1  # Just 1 second is enough
        echo "✅ Switched to workspace 0"
    else
...
echo "🚀 Starting wezterm-rmpc on workspace 0..."
...
echo "✅ wezterm-rmpc started (PID: $APP_PID) on workspace 0"
...
echo "🎉 wezterm-rmpc launch completed!"
exit 0
