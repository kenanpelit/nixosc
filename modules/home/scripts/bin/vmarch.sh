...
declare -A CONFIG=(
  ...
  [disk_size]="128G"
  [ssh_port]="2244"
  [iso_url]="https://mirror.accum.se/mirror/arcolinux.info/iso/v25.01.01/arconet-v25.01.01-x86_64.iso"
  [display_mode]="gtk"
  [boot_mode]="bios"
)

# Derived paths
CONFIG[iso_file]="${CONFIG[base_dir]}/arconet-v25.01.01-x86_64.iso"
