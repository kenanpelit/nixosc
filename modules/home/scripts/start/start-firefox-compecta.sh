...
readonly COMMAND="firefox"
readonly ARGS_STR="-P compecta --class Compecta --name Compecta --new-window --new-instance"
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-compecta.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-compecta.cmd"
