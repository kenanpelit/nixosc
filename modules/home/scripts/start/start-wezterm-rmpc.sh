...
readonly ARGS_STR="start --class rmpc -e rmpc"
...
echo "Initializing wezterm-rmpc on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/wezterm-rmpc.pid"
echo "$COMMAND" > "$STATE_DIR/wezterm-rmpc.cmd"
