...
readonly ARGS_STR="--discord --separate --class discord --title discord"
...
echo "Initializing brave-discord on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/brave-discord.pid"
echo "$COMMAND" > "$STATE_DIR/brave-discord.cmd"
