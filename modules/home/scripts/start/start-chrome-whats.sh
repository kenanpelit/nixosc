...
readonly ARGS_STR="Whats --class Whats"
...
echo "Initializing chrome-whats on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/chrome-whats.pid"
echo "$COMMAND" > "$STATE_DIR/chrome-whats.cmd"
