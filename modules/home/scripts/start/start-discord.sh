...
readonly COMMAND="discord"
readonly ARGS_STR="-m --class=discord --title=discord"
...
echo "Initializing discord on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/discord.pid"
echo "$COMMAND" > "$STATE_DIR/discord.cmd"
