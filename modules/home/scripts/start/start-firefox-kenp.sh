...
readonly ARGS_STR="-P kenp --class Kenp --name Kenp --new-window --new-instance"
...
echo "Initializing firefox-kenp on $WM_TYPE..."
...
APP_PID=$!
mkdir -p "$STATE_DIR"
echo "$APP_PID" > "$STATE_DIR/firefox-kenp.pid"
echo "$COMMAND" > "$STATE_DIR/firefox-kenp.cmd"
...
echo "firefox-kenp initialization complete"
exit 0