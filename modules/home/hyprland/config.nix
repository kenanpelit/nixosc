...
let
  ...
  startupServices = [
    ...
    "nm-applet --indicator"
    "/bin/sh -c 'command -v nwg-panel >/dev/null && nwg-panel'"
    "/bin/sh -c 'command -v nwg-dock-hyprland >/dev/null && nwg-dock-hyprland'"
    "/bin/sh -c 'command -v nwg-drawer >/dev/null && nwg-drawer'"
