...
# - Symlink from zen-beta to zen for command consistency
# ==============================================================================
...
in
{
 ...
 # Create a symlink from zen-beta to zen for command consistency
 # =============================================================================
 home.activation = {
   linkZenBrowser = lib.hm.dag.entryAfter ["writeBoundary"] ''
     $DRY_RUN_CMD ln -sf $VERBOSE_ARG ${config.home.profileDirectory}/bin/zen-beta ${config.home.profileDirectory}/bin/zen
   '';
 };
}
