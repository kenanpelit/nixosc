      ...
      require("lazy").setup({
        spec = {
          ...
          -- =======================================================================
          {
            ...
            build = "pip install -q -U google-generativeai",
            config = function()
              require("gemini").setup({
                -- Model Configuration
                model_config = {
                  model_id = 'gemini-3.0-flash-latest',
                  temperature = 0.10,
                  top_k = 128,
                ...
                -- Hints: Shows inline function descriptions
                hints = {
                  enabled = true,
                  hints_delay = 2000,
...
``]] .. '`'
            ...
            keys = {
              -- Gemini Group under AI
              { "<leader>ag", nil, desc = "Gemini" },

              -- Core Commands
              { "<leader>agc", "<cmd>GeminiChat<cr>", desc = "Gemini Chat", mode = { "n", "v" } },
              { "<leader>ags", "<cmd>GeminiStop<cr>", desc = "Stop Generation" },
              { "<leader>agn", "<cmd>GeminiNew<cr>", desc = "New Chat" },
              { "<leader>agr", "<cmd>GeminiReset<cr>", desc = "Reset History" },

              -- Code Actions
              { "<leader>age", "<cmd>GeminiExplain<cr>", desc = "Explain Code", mode = { "n", "v" } },
              { "<leader>agf", "<cmd>GeminiFixBugs<cr>", desc = "Fix Bugs", mode = { "n", "v" } },
              { "<leader>ago", "<cmd>GeminiOptimize<cr>", desc = "Optimize Code", mode = { "n", "v" } },
              { "<leader>agt", "<cmd>GeminiAddTests<cr>", desc = "Add Tests", mode = { "n", "v" } },
              { "<leader>agd", "<cmd>GeminiAddDoc<cr>", desc = "Add Documentation", mode = { "n", "v" } },
            },
          },
